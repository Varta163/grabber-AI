import { Cpu, Code2, Palette, Briefcase, TrendingUp, Newspaper, Zap, LayoutDashboard, MessageSquare, Shield, X } from 'lucide-react'
  ...
  return (
    <>
      ...
      <aside className={clsx(
        'fixed md:relative inset-y-0 left-0 z-30 w-64 md:w-56 flex-shrink-0 h-screen flex flex-col border-r border-bg-border bg-bg-secondary transition-transform duration-200',
